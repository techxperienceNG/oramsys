...
const Paginate = ({ postsPerPage, totalPosts, getAllEntities, paginate, prevPagefunc, currentPage, nextPagefunc }) => {
    const pageNumbers = []
    ...
    return (
        <div className='d-flex align-items-center justify-content-between' aria-label="...">
            <div className='pe-4'>
            <span className="text-muted fs-6 fw-light">Showing {getAllEntities?.length } out of {totalPosts}</span>
